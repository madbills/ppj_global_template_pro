    ...
    function MapViewModel(mapObject, mapid) {
        ...
        *
        ...
        self.showInfoWindow = function (location) {
            ...
            if (mapObject.options.hideinfowindow !== "true") {
                ...
                content += '<span class="loc-phone">'+location.maplistTelephone+'</span>';
                content += '<span class="loc-time">'+location.maplistHours+'</span>';
        ...
        * UTILITIES
        ...
        function Location(item) {
            ...
            this.maplistHours = item.maplistHours;
            this.maplistTelephone = item.maplistTelephone;
